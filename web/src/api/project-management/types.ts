...
export interface Requirement {
  ...
  iteration?: Iteration
  milestone?: Milestone
  version?: { versionId: string; versionNo: string; versionName?: string }
...
export interface WorkCountsSummary {
...
export interface DashboardSummary extends WorkCountsSummary {
...
export interface ProjectProgressForm extends Pick<
  ProjectRef,
  | 'projectStage'
  | 'plannedStartTime'
  | 'plannedEndTime'
...
export interface RiskItems {
  blockingBugs: Array<Record<string, unknown>>
...
export interface ProjectOverview {
  ...
  bugClosed: number
  bugCloseRate: number
  counts: WorkCountsSummary
  currentRequirements: Requirement[]
  currentBugs: Array<Record<string, unknown>>
  pendingRequirements: Requirement[]
  pendingBugs: Array<Record<string, unknown>>
  completedRequirements: Requirement[]
  completedBugs: Array<Record<string, unknown>>
