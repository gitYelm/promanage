...
export class ProjectManagementController {
  ...
  @Get('executive-dashboard/summary') @RequirePermission('pm:executive-dashboard:view') @ApiOperation({ summary: '仪表盘总览' }) summary(@Query() query: ProjectDashboardQueryDto, @Req() req: RequestWithUser) { return this.dashboard.summary(query, req.user) }
